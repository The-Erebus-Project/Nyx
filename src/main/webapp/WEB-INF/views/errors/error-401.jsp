        ...
        <div class="content-wrapper container-fluid mt-3">
            <div class="error-container mx-auto">
                <div class="text-center">
                    <h1 class="error-header">Unauthorized</h1>
                </div>
                ...
                <div class="alert alert-danger">
                    ...
                    <p class="mb-0">Looks like you don't have proper authorization to get here. No worries, it's most likely a misunderstanding. Please, contact the system administrator.</p>
                </div>
